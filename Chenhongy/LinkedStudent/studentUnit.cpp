...
{
    ifstream infile("Chenhongy/LinkedStudent/student.dat", ios::in | ios::binary);
    if (!infile)
    {
...
{
    ofstream outfile("Chenhongy/LinkedStudent/student.dat", ios::out|ios::binary);
    if (!outfile)
    {
